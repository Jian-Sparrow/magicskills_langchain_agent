#!/usr/bin/env python3
"""
MagicSkills HTTP API Server (基于官方 Python API)
将 MagicSkills 所有功能通过 HTTP API 暴露
...
# 添加 magicskills 到路径
sys.path.insert(0, '/root/miniforge3/envs/magicskills/lib/python3.10/site-packages')
...
# 配置
SKILLS_DIR = Path("/home/admin/.openclaw/workspace/skills/allskills")
AGENTS_MD_PATH = Path("/home/admin/.openclaw/workspace/AGENTS.md")
...
def index():
    ...
    return jsonify({
        ...
        "version": "2.0",
        "description": "基于官方 Python API 的完整实现",
        "endpoints": {
            "GET /health": "健康检查",
...
if __name__ == '__main__':
    print("="*60)
    print("MagicSkills HTTP API Server v2.0")
    print("="*60)
    print(f"基于官方 Python API")
